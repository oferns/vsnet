namespace VD.PayOn {
    ...
    public enum PaymentType {
        ...
        [Description("Rebill: A rebill is performed against a previous payment, referencing its payment.id. A rebill can be sent against a prior debit (DB payment type) transaction.")]
        Rebill
    }
}
